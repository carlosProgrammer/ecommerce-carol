...
<footer class="page-footer font-small blue-grey lighten-5">
  <div style="background-color: #FBE4D4;">
    <div class="container">
  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-3 dark-grey-text">
      ...
      <div class="col-md-3 col-lg-4 col-xl-3 mb-4">
        ...
        Odio consectetur, eos animi aperiam, 
        recusandae eligendi blanditiis aliquam quae deserunt consequatur vel 
        harum impedit id repudiandae accusamus ea dolor omnis ut.</p>
